 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wc=!0;function U(n,e=null){if(n===null)return g.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),f(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new M(t,U(e))}if(!(n instanceof Array)&&wc){const t=[];let s=!1;if(q(n,(o,a)=>{if(o.substring(0,1)!=="."){const l=U(a);l.isEmpty()||(s=s||!l.getPriority().isEmpty(),t.push(new v(o,l)))}}),t.length===0)return g.EMPTY_NODE;const r=Rt(t,_c,o=>o.name,Vn);if(s){const o=Rt(t,D.getCompare());return new g(r,U(e),new ee({".priority":o},{".priority":D}))}else return new g(r,U(e),ee.Default)}else{let t=g.EMPTY_NODE;return q(n,(s,i)=>{if(se(n,s)&&s.substring(0,1)!=="."){const r=U(i);(r.isLeafNode()||!r.isEmpty())&&(t=t.updateImmediateChild(s,r))}}),t.updatePriority(U(e))}}mc(U);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ht(n,e){return{eventCache:n,serverCache:e}}function Ke(n,e,t,s){return Ht(new we(e,t,s),n.serverCache)}function gr(n,e,t,s){return Ht(n.eventCache,new we(e,t,s))}function En(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function be(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zn(n,e){return wr(e,n)}function Wc(n,e,t,s,i){f(s>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:s,visible:i}),i&&(n.visibleWrites=Qe(n.visibleWrites,e,t)),n.lastWriteId=s}function Vc(n,e){for(let t=0;t<n.allWrites.length;t++){const s=n.allWrites[t];if(s.writeId===e)return s}return null}function Hc(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);f(t>=0,"removeWrite called with nonexistent writeId.");const s=n.allWrites[t];n.allWrites.splice(t,1);let i=s.visible,r=!1,o=n.allWrites.length-1;for(;i&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&$c(a,s.path)?i=!1:K(s.path,a.path)&&(r=!0)),o--}if(i){if(r)return qc(n),!0;if(s.snap)n.visibleWrites=Ks(n.visibleWrites,s.path);else{const a=s.children;q(a,l=>{n.visibleWrites=Ks(n.visibleWrites,O(s.path,l))})}return!0}else return!1}function $c(n,e){if(n.snap)return K(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&K(O(n.path,t),e))return!0;return!1}function qc(n){n.visibleWrites=vr(n.allWrites,jc,I()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function jc(n){return n.visible}function vr(n,e,t){let s=X.empty();for(let i=0;i<n.length;++i){const r=n[i];if(e(r)){const o=r.path;let a;if(r.snap)K(t,o)?(a=H(t,o),s=Qe(s,a,r.snap)):K(o,t)&&(a=H(o,t),s=Qe(s,I(),r.snap.getChild(a)));else if(r.children){if(K(t,o))a=H(t,o),s=Ys(s,a,r.children);else if(K(o,t))if(a=H(o,t),E(a))s=Ys(s,I(),r.children);else{const l=Le(r.children,C(a));if(l){const c=l.getChild(x(a));s=Qe(s,I(),c)}}}else throw We("WriteRecord should have .snap or .children")}}return s}function Cr(n,e,t,s,i){if(!s&&!i){const r=Te(n.visibleWrites,e);if(r!=null)return r;{const o=le(n.visibleWrites,e);if(bn(o))return t;if(t==null&&!wn(o,I()))return null;{const a=t||g.EMPTY_NODE;return Ue(o,a)}}}else{const r=le(n.visibleWrites,e);if(!i&&bn(r))return t;if(!i&&t==null&&!wn(r,I()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(K(c.path,e)||K(e,c.path))},a=vr(n.allWrites,o,e),l=t||g.EMPTY_NODE;return Ue(a,l)}}}function zc(n,e,t){let s=g.EMPTY_NODE;const i=Te(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(D,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(t){const r=le(n.visibleWrites,e);return t.forEachChild(D,(o,a)=>{const l=Ue(le(r,new R(o)),a);s=s.updateImmediateChild(o,l)}),Qs(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=le(n.visibleWrites,e);return Qs(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function Gc(n,e,t,s,i){f(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=O(e,t);if(wn(n.visibleWrites,r))return null;{const o=le(n.visibleWrites,r);return bn(o)?i.getChild(t):Ue(o,i.getChild(t))}}function Yc(n,e,t,s){const i=O(e,t),r=Te(n.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(t)){const o=le(n.visibleWrites,i);return Ue(o,s.getNode().getImmediateChild(t))}else return null}function Kc(n,e){return Te(n.visibleWrites,e)}function Qc(n,e,t,s,i,r,o){let a;const l=le(n.visibleWrites,e),c=Te(l,I());if(c!=null)a=c;else if(t!=null)a=Ue(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const h=[],u=o.getCompare(),d=r?a.getReverseIteratorFrom(s,o):a.getIteratorFrom(s,o);let _=d.getNext();for(;_&&h.length<i;)u(_,s)!==0&&h.push(_),_=d.getNext();return h}else return[]}function Xc(){return{visibleWrites:X.empty(),allWrites:[],lastWriteId:-1}}function At(n,e,t,s){return Cr(n.writeTree,n.treePath,e,t,s)}function Gn(n,e){return zc(n.writeTree,n.treePath,e)}function Xs(n,e,t,s){return Gc(n.writeTree,n.treePath,e,t,s)}function Dt(n,e){return Kc(n.writeTree,O(n.treePath,e))}function Jc(n,e,t,s,i,r){return Qc(n.writeTree,n.treePath,e,t,s,i,r)}function Yn(n,e,t){return Yc(n.writeTree,n.treePath,e,t)}function Er(n,e){return wr(O(n.treePath,e),n.writeTree)}function wr(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eh{getCompleteChild(e){return null}getChildAfterChild(e,t,s){return null}}const br=new eh;class Kn{constructor(e,t,s=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=s}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new we(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Yn(this.writes_,e,s)}}getChildAfterChild(e,t,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:be(this.viewCache_),r=Jc(this.writes_,i,t,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
