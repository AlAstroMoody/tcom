 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _=function(n,e){if(!n)throw Me(e)},Me=function(n){return new Error("Firebase Database ("+_i.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ct extends er{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Ci()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Ct}getInitialEvent(e){return _(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let fn;function cc(n){fn=n}const or=function(n){return typeof n=="number"?"number:"+Li(n):"string:"+n},ar=function(n){if(n.isLeafNode()){const e=n.val();_(typeof e=="string"||typeof e=="number"||typeof e=="object"&&ne(e,".sv"),"Priority must be a string or number.")}else _(n===fn||n.isEmpty(),"priority of unexpected type.");_(n===fn||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fc=Math.log(2);class _c{constructor(e){const t=r=>parseInt(Math.log(r)/fc,10),s=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=s(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Et=function(n,e,t,s){n.sort(e);const i=function(l,c){const d=c-l;let h,u;if(d===0)return null;if(d===1)return h=n[l],u=t?t(h):h,new M(u,h.node,M.BLACK,null,null);{const f=parseInt(d/2,10)+l,p=i(l,f),y=i(f+1,c);return h=n[f],u=t?t(h):h,new M(u,h.node,M.BLACK,p,y)}},r=function(l){let c=null,d=null,h=n.length;const u=function(p,y){const w=h-p,I=h;h-=p;const S=i(w+1,I),j=n[w],Be=t?t(j):j;f(new M(Be,j.node,y,null,S))},f=function(p){c?(c.left=p,c=p):(d=p,c=p)};for(let p=0;p<l.count;++p){const y=l.nextBitIsOne(),w=Math.pow(2,l.count-(p+1));y?u(w,M.BLACK):(u(w,M.BLACK),u(w,M.RED))}return d},o=new _c(n.length),a=r(o);return new H(s||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xt;const Ce={};class Z{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return _(Ce&&D,"ChildrenNode.ts has not been loaded"),Xt=Xt||new Z({".priority":Ce},{".priority":D}),Xt}get(e){const t=Ae(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof H?t:null}hasIndex(e){return ne(this.indexSet_,e.toString())}addIndex(e,t){_(e!==xe,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=t.getIterator(v.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let a;i?a=Et(s,e.getCompare()):a=Ce;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const d=Object.assign({},this.indexes_);return d[l]=a,new Z(d,c)}addToIndexes(e,t){const s=mt(this.indexes_,(i,r)=>{const o=Ae(this.indexSet_,r);if(_(o,"Missing index implementation for "+r),i===Ce)if(o.isDefinedOn(e.node)){const a=[],l=t.getIterator(v.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),Et(a,o.getCompare())}else return Ce;else{const a=t.get(e.name);let l=i;return a&&(l=l.remove(new v(e.name,a))),l.insert(e,e.node)}});return new Z(s,this.indexSet_)}removeFromIndexes(e,t){const s=mt(this.indexes_,i=>{if(i===Ce)return i;{const r=t.get(e.name);return r?i.remove(new v(e.name,r)):i}});return new Z(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ln{constructor(e){this.index_=e}updateChild(e,t,s,i,r,o){_(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(i).equals(s.getChild(i))&&a.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(t)?o.trackChildChange(Xe(t,a)):_(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Pe(t,s)):o.trackChildChange(Je(t,s,a))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(t,s).withIndex(this.index_)}updateFullNode(e,t,s){return s!=null&&(e.isLeafNode()||e.forEachChild(D,(i,r)=>{t.hasChild(i)||s.trackChildChange(Xe(i,r))}),t.isLeafNode()||t.forEachChild(D,(i,r)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(r)||s.trackChildChange(Je(i,r,o))}else s.trackChildChange(Pe(i,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?m.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wt extends Zi{constructor(e,t,s,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=s,this.appCheckTokenProvider_=i,this.log_=rt("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(_(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,s,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=wt.getListenId_(e,s),a={};this.listens_[o]=a;const l=Hs(e._queryParams);this.restRequest_(r+".json",l,(c,d)=>{let h=d;if(c===404&&(h=null,c=null),c===null&&this.onDataUpdate_(r,h,!1,s),Ae(this.listens_,o)===a){let u;c?c===401?u="permission_denied":u="rest_error:"+c:u="ok",i(u,null)}})}unlisten(e,t){const s=wt.getListenId_(e,t);delete this.listens_[s]}get(e){const t=Hs(e._queryParams),s=e._path.toString(),i=new Rn;return this.restRequest_(s+".json",t,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(s,a,!1,null),i.resolve(a)):i.reject(new Error(a))}),i.promise}refreshAuthToken(e){}restRequest_(e,t={},s){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,r])=>{i&&i.accessToken&&(t.auth=i.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+Jo(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(s&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=Ge(a.responseText)}catch{$("Failed to parse JSON response for "+o+": "+a.responseText)}s(null,l)}else a.status!==401&&a.status!==404&&$("Got unsuccessful REST response for "+o+" Status: "+a.status),s(a.status);s=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bt(){return{value:null,children:new Map}}function ur(n,e,t){if(E(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const s=C(e);n.children.has(s)||n.children.set(s,bt());const i=n.children.get(s);e=x(e),ur(i,e,t)}}function _n(n,e,t){n.value!==null?t(e,n.value):Ic(n,(s,i)=>{const r=new T(e.toString()+"/"+s);_n(i,r,t)})}function Ic(n,e){n.children.forEach((t,s)=>{e(s,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class It{constructor(e,t,s){this.path=e,this.affectedTree=t,this.revert=s,this.type=Q.ACK_USER_WRITE,this.source=dr()}operationForChild(e){if(E(this.path)){if(this.affectedTree.value!=null)return _(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new T(e));return new It(b(),t,this.revert)}}else return _(C(this.path)===e,"operationForChild called for unrelated child."),new It(x(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class et{constructor(e,t){this.source=e,this.path=t,this.type=Q.LISTEN_COMPLETE}operationForChild(e){return E(this.path)?new et(this.source,b()):new et(this.source,x(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pe{constructor(e,t,s){this.source=e,this.path=t,this.snap=s,this.type=Q.OVERWRITE}operationForChild(e){return E(this.path)?new pe(this.source,b(),this.snap.getImmediateChild(e)):new pe(this.source,x(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tt{constructor(e,t,s){this.source=e,this.path=t,this.children=s,this.type=Q.MERGE}operationForChild(e){if(E(this.path)){const t=this.children.subtree(new T(e));return t.isEmpty()?null:t.value?new pe(this.source,b(),t.value):new tt(this.source,b(),t)}else return _(C(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new tt(this.source,x(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Jt;const Pc=()=>(Jt||(Jt=new H(yl)),Jt);class k{constructor(e,t=Pc()){this.value=e,this.children=t}static fromObject(e){let t=new k(null);return V(e,(s,i)=>{t=t.set(new T(s),i)}),t}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(this.value!=null&&t(this.value))return{path:b(),value:this.value};if(E(e))return null;{const s=C(e),i=this.children.get(s);if(i!==null){const r=i.findRootMostMatchingPathAndValue(x(e),t);return r!=null?{path:P(new T(s),r.path),value:r.value}:null}else return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(E(e))return this;{const t=C(e),s=this.children.get(t);return s!==null?s.subtree(x(e)):new k(null)}}set(e,t){if(E(e))return new k(t,this.children);{const s=C(e),r=(this.children.get(s)||new k(null)).set(x(e),t),o=this.children.insert(s,r);return new k(this.value,o)}}remove(e){if(E(e))return this.children.isEmpty()?new k(null):new k(null,this.children);{const t=C(e),s=this.children.get(t);if(s){const i=s.remove(x(e));let r;return i.isEmpty()?r=this.children.remove(t):r=this.children.insert(t,i),this.value===null&&r.isEmpty()?new k(null):new k(this.value,r)}else return this}}get(e){if(E(e))return this.value;{const t=C(e),s=this.children.get(t);return s?s.get(x(e)):null}}setTree(e,t){if(E(e))return t;{const s=C(e),r=(this.children.get(s)||new k(null)).setTree(x(e),t);let o;return r.isEmpty()?o=this.children.remove(s):o=this.children.insert(s,r),new k(this.value,o)}}fold(e){return this.fold_(b(),e)}fold_(e,t){const s={};return this.children.inorderTraversal((i,r)=>{s[i]=r.fold_(P(e,i),t)}),t(e,this.value,s)}findOnPath(e,t){return this.findOnPath_(e,b(),t)}findOnPath_(e,t,s){const i=this.value?s(t,this.value):!1;if(i)return i;if(E(e))return null;{const r=C(e),o=this.children.get(r);return o?o.findOnPath_(x(e),P(t,r),s):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,b(),t)}foreachOnPath_(e,t,s){if(E(e))return this;{this.value&&s(t,this.value);const i=C(e),r=this.children.get(i);return r?r.foreachOnPath_(x(e),P(t,i),s):new k(null)}}foreach(e){this.foreach_(b(),e)}foreach_(e,t){this.children.inorderTraversal((s,i)=>{i.foreach_(P(e,s),t)}),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal((t,s)=>{s.value&&e(t,s.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Un(n,e){return yr(e,n)}function Oc(n,e,t,s,i){_(s>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:s,visible:i}),i&&(n.visibleWrites=je(n.visibleWrites,e,t)),n.lastWriteId=s}function Mc(n,e){for(let t=0;t<n.allWrites.length;t++){const s=n.allWrites[t];if(s.writeId===e)return s}return null}function Lc(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);_(t>=0,"removeWrite called with nonexistent writeId.");const s=n.allWrites[t];n.allWrites.splice(t,1);let i=s.visible,r=!1,o=n.allWrites.length-1;for(;i&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&Fc(a,s.path)?i=!1:K(s.path,a.path)&&(r=!0)),o--}if(i){if(r)return Bc(n),!0;if(s.snap)n.visibleWrites=js(n.visibleWrites,s.path);else{const a=s.children;V(a,l=>{n.visibleWrites=js(n.visibleWrites,P(s.path,l))})}return!0}else return!1}function Fc(n,e){if(n.snap)return K(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&K(P(n.path,t),e))return!0;return!1}function Bc(n){n.visibleWrites=pr(n.allWrites,Wc,b()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function Wc(n){return n.visible}function pr(n,e,t){let s=X.empty();for(let i=0;i<n.length;++i){const r=n[i];if(e(r)){const o=r.path;let a;if(r.snap)K(t,o)?(a=U(t,o),s=je(s,a,r.snap)):K(o,t)&&(a=U(o,t),s=je(s,b(),r.snap.getChild(a)));else if(r.children){if(K(t,o))a=U(t,o),s=$s(s,a,r.children);else if(K(o,t))if(a=U(o,t),E(a))s=$s(s,b(),r.children);else{const l=Ae(r.children,C(a));if(l){const c=l.getChild(x(a));s=je(s,b(),c)}}}else throw Me("WriteRecord should have .snap or .children")}}return s}function mr(n,e,t,s,i){if(!s&&!i){const r=ye(n.visibleWrites,e);if(r!=null)return r;{const o=oe(n.visibleWrites,e);if(gn(o))return t;if(t==null&&!mn(o,b()))return null;{const a=t||m.EMPTY_NODE;return Oe(o,a)}}}else{const r=oe(n.visibleWrites,e);if(!i&&gn(r))return t;if(!i&&t==null&&!mn(r,b()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(K(c.path,e)||K(e,c.path))},a=pr(n.allWrites,o,e),l=t||m.EMPTY_NODE;return Oe(a,l)}}}function Uc(n,e,t){let s=m.EMPTY_NODE;const i=ye(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(D,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(t){const r=oe(n.visibleWrites,e);return t.forEachChild(D,(o,a)=>{const l=Oe(oe(r,new T(o)),a);s=s.updateImmediateChild(o,l)}),zs(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=oe(n.visibleWrites,e);return zs(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function Hc(n,e,t,s,i){_(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=P(e,t);if(mn(n.visibleWrites,r))return null;{const o=oe(n.visibleWrites,r);return gn(o)?i.getChild(t):Oe(o,i.getChild(t))}}function Vc(n,e,t,s){const i=P(e,t),r=ye(n.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(t)){const o=oe(n.visibleWrites,i);return Oe(o,s.getNode().getImmediateChild(t))}else return null}function qc(n,e){return ye(n.visibleWrites,e)}function $c(n,e,t,s,i,r,o){let a;const l=oe(n.visibleWrites,e),c=ye(l,b());if(c!=null)a=c;else if(t!=null)a=Oe(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const d=[],h=o.getCompare(),u=r?a.getReverseIteratorFrom(s,o):a.getIteratorFrom(s,o);let f=u.getNext();for(;f&&d.length<i;)h(f,s)!==0&&d.push(f),f=u.getNext();return d}else return[]}function jc(){return{visibleWrites:X.empty(),allWrites:[],lastWriteId:-1}}function Tt(n,e,t,s){return mr(n.writeTree,n.treePath,e,t,s)}function Hn(n,e){return Uc(n.writeTree,n.treePath,e)}function Gs(n,e,t,s){return Hc(n.writeTree,n.treePath,e,t,s)}function St(n,e){return qc(n.writeTree,P(n.treePath,e))}function zc(n,e,t,s,i,r){return $c(n.writeTree,n.treePath,e,t,s,i,r)}function Vn(n,e,t){return Vc(n.writeTree,n.treePath,e,t)}function gr(n,e){return yr(P(n.treePath,e),n.writeTree)}function yr(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kc(n){return{filter:n}}function Qc(n,e){_(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),_(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function Xc(n,e,t,s,i){const r=new Gc;let o,a;if(t.type===Q.OVERWRITE){const c=t;c.source.fromUser?o=yn(n,e,c.path,c.snap,s,i,r):(_(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!E(c.path),o=Rt(n,e,c.path,c.snap,s,i,a,r))}else if(t.type===Q.MERGE){const c=t;c.source.fromUser?o=Zc(n,e,c.path,c.children,s,i,r):(_(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=vn(n,e,c.path,c.children,s,i,a,r))}else if(t.type===Q.ACK_USER_WRITE){const c=t;c.revert?o=nh(n,e,c.path,s,i,r):o=eh(n,e,c.path,c.affectedTree,s,i,r)}else if(t.type===Q.LISTEN_COMPLETE)o=th(n,e,t.path,s,r);else throw Me("Unknown operation type: "+t.type);const l=r.getChanges();return Jc(e,o,l),{viewCache:o,changes:l}}function Jc(n,e,t){const s=e.eventCache;if(s.isFullyInitialized()){const i=s.getNode().isLeafNode()||s.getNode().isEmpty(),r=pn(n);(t.length>0||!n.eventCache.isFullyInitialized()||i&&!s.getNode().equals(r)||!s.getNode().getPriority().equals(r.getPriority()))&&t.push(hr(pn(e)))}}function Cr(n,e,t,s,i,r){const o=e.eventCache;if(St(s,t)!=null)return e;{let a,l;if(E(t))if(_(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=ge(e),d=c instanceof m?c:m.EMPTY_NODE,h=Hn(s,d);a=n.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const c=Tt(s,ge(e));a=n.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=C(t);if(c===".priority"){_(ae(t)===1,"Can't have a priority with additional path components");const d=o.getNode();l=e.serverCache.getNode();const h=Gs(s,t,d,l);h!=null?a=n.filter.updatePriority(d,h):a=o.getNode()}else{const d=x(t);let h;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const u=Gs(s,t,o.getNode(),l);u!=null?h=o.getNode().getImmediateChild(c).updateChild(d,u):h=o.getNode().getImmediateChild(c)}else h=Vn(s,c,e.serverCache);h!=null?a=n.filter.updateChild(o.getNode(),c,h,d,i,r):a=o.getNode()}}return $e(e,a,o.isFullyInitialized()||E(t),n.filter.filtersNodes())}}function Rt(n,e,t,s,i,r,o,a){const l=e.serverCache;let c;const d=o?n.filter:n.filter.getIndexedFilter();if(E(t))c=d.updateFullNode(l.getNode(),s,null);else if(d.filtersNodes()&&!l.isFiltered()){const f=l.getNode().updateChild(t,s);c=d.updateFullNode(l.getNode(),f,null)}else{const f=C(t);if(!l.isCompleteForPath(t)&&ae(t)>1)return e;const p=x(t),w=l.getNode().getImmediateChild(f).updateChild(p,s);f===".priority"?c=d.updatePriority(l.getNode(),w):c=d.updateChild(l.getNode(),f,w,p,vr,null)}const h=fr(e,c,l.isFullyInitialized()||E(t),d.filtersNodes()),u=new qn(i,h,r);return Cr(n,h,t,i,u,a)}function yn(n,e,t,s,i,r,o){const a=e.eventCache;let l,c;const d=new qn(i,e,r);if(E(t))c=n.filter.updateFullNode(e.eventCache.getNode(),s,o),l=$e(e,c,!0,n.filter.filtersNodes());else{const h=C(t);if(h===".priority")c=n.filter.updatePriority(e.eventCache.getNode(),s),l=$e(e,c,a.isFullyInitialized(),a.isFiltered());else{const u=x(t),f=a.getNode().getImmediateChild(h);let p;if(E(u))p=s;else{const y=d.getCompleteChild(h);y!=null?tr(u)===".priority"&&y.getChild(sr(u)).isEmpty()?p=y:p=y.updateChild(u,s):p=m.EMPTY_NODE}if(f.equals(p))l=e;else{const y=n.filter.updateChild(a.getNode(),h,p,u,d,o);l=$e(e,y,a.isFullyInitialized(),n.filter.filtersNodes())}}}return l}function Ys(n,e){return n.eventCache.isCompleteForChild(e)}function Zc(n,e,t,s,i,r,o){let a=e;return s.foreach((l,c)=>{const d=P(t,l);Ys(e,C(d))&&(a=yn(n,a,d,c,i,r,o))}),s.foreach((l,c)=>{const d=P(t,l);Ys(e,C(d))||(a=yn(n,a,d,c,i,r,o))}),a}function Ks(n,e,t){return t.foreach((s,i)=>{e=e.updateChild(s,i)}),e}function vn(n,e,t,s,i,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;E(t)?c=s:c=new k(null).setTree(t,s);const d=e.serverCache.getNode();return c.children.inorderTraversal((h,u)=>{if(d.hasChild(h)){const f=e.serverCache.getNode().getImmediateChild(h),p=Ks(n,f,u);l=Rt(n,l,new T(h),p,i,r,o,a)}}),c.children.inorderTraversal((h,u)=>{const f=!e.serverCache.isCompleteForChild(h)&&u.value===null;if(!d.hasChild(h)&&!f){const p=e.serverCache.getNode().getImmediateChild(h),y=Ks(n,p,u);l=Rt(n,l,new T(h),y,i,r,o,a)}}),l}function eh(n,e,t,s,i,r,o){if(St(i,t)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(s.value!=null){if(E(t)&&l.isFullyInitialized()||l.isCompleteForPath(t))return Rt(n,e,t,l.getNode().getChild(t),i,r,a,o);if(E(t)){let c=new k(null);return l.getNode().forEachChild(xe,(d,h)=>{c=c.set(new T(d),h)}),vn(n,e,t,c,i,r,a,o)}else return e}else{let c=new k(null);return s.foreach((d,h)=>{const u=P(t,d);l.isCompleteForPath(u)&&(c=c.set(d,l.getNode().getChild(u)))}),vn(n,e,t,c,i,r,a,o)}}function th(n,e,t,s,i){const r=e.serverCache,o=fr(e,r.getNode(),r.isFullyInitialized()||E(t),r.isFiltered());return Cr(n,o,t,s,vr,i)}function nh(n,e,t,s,i,r){let o;if(St(s,t)!=null)return e;{const a=new qn(s,e,i),l=e.eventCache.getNode();let c;if(E(t)||C(t)===".priority"){let d;if(e.serverCache.isFullyInitialized())d=Tt(s,ge(e));else{const h=e.serverCache.getNode();_(h instanceof m,"serverChildren would be complete if leaf node"),d=Hn(s,h)}d=d,c=n.filter.updateFullNode(l,d,r)}else{const d=C(t);let h=Vn(s,d,e.serverCache);h==null&&e.serverCache.isCompleteForChild(d)&&(h=l.getImmediateChild(d)),h!=null?c=n.filter.updateChild(l,d,h,x(t),a,r):e.eventCache.getNode().hasChild(d)?c=n.filter.updateChild(l,d,m.EMPTY_NODE,x(t),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Tt(s,ge(e)),o.isLeafNode()&&(c=n.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||St(s,b())!=null,$e(e,c,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sh{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const s=this.query_._queryParams,i=new Ln(s.getIndex()),r=wc(s);this.processor_=Kc(r);const o=t.serverCache,a=t.eventCache,l=i.updateFullNode(m.EMPTY_NODE,o.getNode(),null),c=r.updateFullNode(m.EMPTY_NODE,a.getNode(),null),d=new me(l,o.isFullyInitialized(),i.filtersNodes()),h=new me(c,a.isFullyInitialized(),r.filtersNodes());this.viewCache_=Ft(h,d),this.eventGenerator_=new xc(this.query_)}get query(){return this.query_}}function ih(n){return n.viewCache_.serverCache.getNode()}function rh(n,e){const t=ge(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!E(e)&&!t.getImmediateChild(C(e)).isEmpty())?t.getChild(e):null}function Qs(n){return n.eventRegistrations_.length===0}function oh(n,e){n.eventRegistrations_.push(e)}function Xs(n,e,t){const s=[];if(t){_(e==null,"A cancel should cancel all event registrations.");const i=n.query._path;n.eventRegistrations_.forEach(r=>{const o=r.createCancelEvent(t,i);o&&s.push(o)})}if(e){let i=[];for(let r=0;r<n.eventRegistrations_.length;++r){const o=n.eventRegistrations_[r];if(!o.matches(e))i.push(o);else if(e.hasAnyCallback()){i=i.concat(n.eventRegistrations_.slice(r+1));break}}n.eventRegistrations_=i}else n.eventRegistrations_=[];return s}function Js(n,e,t,s){e.type===Q.MERGE&&e.source.queryId!==null&&(_(ge(n.viewCache_),"We should always have a full cache before handling merges"),_(pn(n.viewCache_),"Missing event cache, even though we have a server cache"));const i=n.viewCache_,r=Xc(n.processor_,i,e,t,s);return Qc(n.processor_,r.viewCache),_(r.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=r.viewCache,Er(n,r.changes,r.viewCache.eventCache.getNode(),null)}function ah(n,e){const t=n.viewCache_.eventCache,s=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(D,(r,o)=>{s.push(Pe(r,o))}),t.isFullyInitialized()&&s.push(hr(t.getNode())),Er(n,s,t.getNode(),e)}function Er(n,e,t,s){const i=s?[s]:n.eventRegistrations_;return kc(n.eventGenerator_,e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let xt;function ph(n){_(!xt,"__referenceConstructor has already been defined"),xt=n}function mh(){return _(xt,"Reference.ts has not been loaded"),xt}let gh=1;class Zs{constructor(e){this.listenProvider_=e,this.syncPointTree_=new k(null),this.pendingWriteTree_=jc(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function yh(n,e,t,s,i){return Oc(n.pendingWriteTree_,e,t,s,i),i?lt(n,new pe(dr(),e,t)):[]}function Ie(n,e,t=!1){const s=Mc(n.pendingWriteTree_,e);if(Lc(n.pendingWriteTree_,e)){let r=new k(null);return s.snap!=null?r=r.set(b(),!0):V(s.children,o=>{r=r.set(new T(o),!0)}),lt(n,new It(s.path,r,t))}else return[]}function Wt(n,e,t){return lt(n,new pe(Bn(),e,t))}function vh(n,e,t){const s=k.fromObject(t);return lt(n,new tt(Bn(),e,s))}function Ch(n,e){return lt(n,new et(Bn(),e))}function Eh(n,e,t){const s=jn(n,t);if(s){const i=zn(s),r=i.path,o=i.queryId,a=U(r,e),l=new et(Wn(o),a);return Gn(n,r,l)}else return[]}function Cn(n,e,t,s,i=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||Ir(o,e))){const l=_h(o,e,t,s);uh(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!i){const d=c.findIndex(u=>u._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(r,(u,f)=>le(f));if(d&&!h){const u=n.syncPointTree_.subtree(r);if(!u.isEmpty()){const f=Ih(u);for(let p=0;p<f.length;++p){const y=f[p],w=y.query,I=Nr(n,y);n.listenProvider_.startListening(ze(w),kt(n,w),I.hashFn,I.onComplete)}}}!h&&c.length>0&&!s&&(d?n.listenProvider_.stopListening(ze(e),null):c.forEach(u=>{const f=n.queryToTagMap.get(Ut(u));n.listenProvider_.stopListening(ze(u),f)}))}Th(n,c)}return a}function wh(n,e,t,s){const i=jn(n,s);if(i!=null){const r=zn(i),o=r.path,a=r.queryId,l=U(o,e),c=new pe(Wn(a),l,t);return Gn(n,o,c)}else return[]}function bh(n,e,t,s){const i=jn(n,s);if(i){const r=zn(i),o=r.path,a=r.queryId,l=U(o,e),c=k.fromObject(t),d=new tt(Wn(a),l,c);return Gn(n,o,d)}else return[]}function ei(n,e,t,s=!1){const i=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(i,(u,f)=>{const p=U(u,i);r=r||ke(f,p),o=o||le(f)});let a=n.syncPointTree_.get(i);a?(o=o||le(a),r=r||ke(a,b())):(a=new lh,n.syncPointTree_=n.syncPointTree_.set(i,a));let l;r!=null?l=!0:(l=!1,r=m.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((f,p)=>{const y=ke(p,b());y&&(r=r.updateImmediateChild(f,y))}));const c=Ir(a,e);if(!c&&!e._queryParams.loadsAllData()){const u=Ut(e);_(!n.queryToTagMap.has(u),"View does not exist, but we have a tag");const f=Sh();n.queryToTagMap.set(u,f),n.tagToQueryMap.set(f,u)}const d=Un(n.pendingWriteTree_,i);let h=fh(a,e,t,d,r,l);if(!c&&!o&&!s){const u=br(a,e);h=h.concat(Rh(n,e,u))}return h}function Tr(n,e,t){const i=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=U(o,e),c=ke(a,l);if(c)return c});return mr(i,e,r,t,!0)}function lt(n,e){return Sr(e,n.syncPointTree_,null,Un(n.pendingWriteTree_,b()))}function Sr(n,e,t,s){if(E(n.path))return Rr(n,e,t,s);{const i=e.get(b());t==null&&i!=null&&(t=ke(i,b()));let r=[];const o=C(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,d=gr(s,o);r=r.concat(Sr(a,l,c,d))}return i&&(r=r.concat($n(i,n,s,t))),r}}function Rr(n,e,t,s){const i=e.get(b());t==null&&i!=null&&(t=ke(i,b()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=gr(s,o),d=n.operationForChild(o);d&&(r=r.concat(Rr(d,a,l,c)))}),i&&(r=r.concat($n(i,n,s,t))),r}function Nr(n,e){const t=e.query,s=kt(n,t);return{hashFn:()=>(ih(e)||m.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?Eh(n,t._path,s):Ch(n,t._path);{const r=El(i,t);return Cn(n,t,null,r)}}}}function kt(n,e){const t=Ut(e);return n.queryToTagMap.get(t)}function Ut(n){return n._path.toString()+"$"+n._queryIdentifier}function jn(n,e){return n.tagToQueryMap.get(e)}function zn(n){const e=n.indexOf("$");return _(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new T(n.substr(0,e))}}function Gn(n,e,t){const s=n.syncPointTree_.get(e);_(s,"Missing sync point for query tag that we're tracking");const i=Un(n.pendingWriteTree_,e);return $n(s,t,i,null)}function Ih(n){return n.fold((e,t,s)=>{if(t&&le(t))return[Bt(t)];{let i=[];return t&&(i=wr(t)),V(s,(r,o)=>{i=i.concat(o)}),i}})}function ze(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(mh())(n._repo,n._path):n}function Th(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const i=Ut(s),r=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(r)}}}function Sh(){return gh++}function Rh(n,e,t){const s=e._path,i=kt(n,e),r=Nr(n,t),o=n.listenProvider_.startListening(ze(e),i,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(s);if(i)_(!le(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,d,h)=>{if(!E(c)&&d&&le(d))return[Bt(d).query];{let u=[];return d&&(u=u.concat(wr(d).map(f=>f.query))),V(h,(f,p)=>{u=u.concat(p)}),u}});for(let c=0;c<l.length;++c){const d=l[c];n.listenProvider_.stopListening(ze(d),kt(n,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qh="repo_interrupt",$h=25;class jh{constructor(e,t,s,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Hh,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=bt(),this.transactionQueueTree_=new Xn,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function zh(n,e,t){if(n.stats_=An(n.repoInfo_),n.forceRestClient_||Tl())n.server_=new wt(n.repoInfo_,(s,i,r,o)=>{ni(n,s,i,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>si(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{L(t)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}n.persistentConnection_=new ee(n.repoInfo_,e,(s,i,r,o)=>{ni(n,s,i,r,o)},s=>{si(n,s)},s=>{Yh(n,s)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(s=>{n.server_.refreshAuthToken(s)}),n.appCheckProvider_.addTokenChangeListener(s=>{n.server_.refreshAppCheckToken(s.token)}),n.statsReporter_=kl(n.repoInfo_,()=>new Nc(n.stats_,n.server_)),n.infoData_=new bc,n.infoSyncTree_=new Zs({startListening:(s,i,r,o)=>{let a=[];const l=n.infoData_.getNode(s._path);return l.isEmpty()||(a=Wt(n.infoSyncTree_,s._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Zn(n,"connected",!1),n.serverSyncTree_=new Zs({startListening:(s,i,r,o)=>(n.server_.listen(s,r,i,(a,l)=>{const c=o(a,l);ve(n.eventQueue_,s._path,c)}),[]),stopListening:(s,i)=>{n.server_.unlisten(s,i)}})}function Gh(n){const t=n.infoData_.getNode(new T(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Wr(n){return Nh({timestamp:Gh(n)})}function ni(n,e,t,s,i){n.dataUpdateCount++;const r=new T(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(i)if(s){const l=mt(t,c=>B(c));o=bh(n.serverSyncTree_,r,l,i)}else{const l=B(t);o=wh(n.serverSyncTree_,r,l,i)}else if(s){const l=mt(t,c=>B(c));o=vh(n.serverSyncTree_,r,l)}else{const l=B(t);o=Wt(n.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=ts(n,r)),ve(n.eventQueue_,a,o)}function si(n,e){Zn(n,"connected",e),e===!1&&Qh(n)}function Yh(n,e){V(e,(t,s)=>{Zn(n,t,s)})}function Zn(n,e,t){const s=new T("/.info/"+e),i=B(t);n.infoData_.updateSnapshot(s,i);const r=Wt(n.infoSyncTree_,s,i);ve(n.eventQueue_,s,r)}function Kh(n){return n.nextWriteId_++}function Qh(n){Ur(n,"onDisconnectEvents");const e=Wr(n),t=bt();_n(n.onDisconnect_,b(),(i,r)=>{const o=Ah(i,r,n.serverSyncTree_,e);ur(t,i,o)});let s=[];_n(t,b(),(i,r)=>{s=s.concat(Wt(n.serverSyncTree_,i,r));const o=tu(n,i);ts(n,o)}),n.onDisconnect_=bt(),ve(n.eventQueue_,b(),s)}function Xh(n,e,t){let s;C(e._path)===".info"?s=ei(n.infoSyncTree_,e,t):s=ei(n.serverSyncTree_,e,t),Fr(n.eventQueue_,e._path,s)}function ii(n,e,t){let s;C(e._path)===".info"?s=Cn(n.infoSyncTree_,e,t):s=Cn(n.serverSyncTree_,e,t),Fr(n.eventQueue_,e._path,s)}function Jh(n){n.persistentConnection_&&n.persistentConnection_.interrupt(qh)}function Ur(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),F(t,...e)}function Hr(n,e,t){return Tr(n.serverSyncTree_,e,t)||m.EMPTY_NODE}function es(n,e=n.transactionQueueTree_){if(e||Vt(n,e),Fe(e)){const t=qr(n,e);_(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&Zh(n,ct(e),t)}else kr(e)&&Ht(e,t=>{es(n,t)})}function Zh(n,e,t){const s=t.map(c=>c.currentWriteId),i=Hr(n,e,s);let r=i;const o=i.hash();for(let c=0;c<t.length;c++){const d=t[c];_(d.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),d.status=1,d.retryCount++;const h=U(e,d.path);r=r.updateChild(h,d.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;n.server_.put(l.toString(),a,c=>{Ur(n,"transaction put response",{path:l.toString(),status:c});let d=[];if(c==="ok"){const h=[];for(let u=0;u<t.length;u++)t[u].status=2,d=d.concat(Ie(n.serverSyncTree_,t[u].currentWriteId)),t[u].onComplete&&h.push(()=>t[u].onComplete(null,!0,t[u].currentOutputSnapshotResolved)),t[u].unwatcher();Vt(n,Jn(n.transactionQueueTree_,e)),es(n,n.transactionQueueTree_),ve(n.eventQueue_,e,d);for(let u=0;u<h.length;u++)ot(h[u])}else{if(c==="datastale")for(let h=0;h<t.length;h++)t[h].status===3?t[h].status=4:t[h].status=0;else{$("transaction at "+l.toString()+" failed: "+c);for(let h=0;h<t.length;h++)t[h].status=4,t[h].abortReason=c}ts(n,e)}},o)}function ts(n,e){const t=Vr(n,e),s=ct(t),i=qr(n,t);return eu(n,i,s),s}function eu(n,e,t){if(e.length===0)return;const s=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=U(t,l.path);let d=!1,h;if(_(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)d=!0,h=l.abortReason,i=i.concat(Ie(n.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=$h)d=!0,h="maxretry",i=i.concat(Ie(n.serverSyncTree_,l.currentWriteId,!0));else{const u=Hr(n,l.path,o);l.currentInputSnapshot=u;const f=e[a].update(u.val());if(f!==void 0){Or("transaction failed: Data returned ",f,l.path);let p=B(f);typeof f=="object"&&f!=null&&ne(f,".priority")||(p=p.updatePriority(u.getPriority()));const w=l.currentWriteId,I=Wr(n),S=Dh(p,u,I);l.currentOutputSnapshotRaw=p,l.currentOutputSnapshotResolved=S,l.currentWriteId=Kh(n),o.splice(o.indexOf(w),1),i=i.concat(yh(n.serverSyncTree_,l.path,S,l.currentWriteId,l.applyLocally)),i=i.concat(Ie(n.serverSyncTree_,w,!0))}else d=!0,h="nodata",i=i.concat(Ie(n.serverSyncTree_,l.currentWriteId,!0))}ve(n.eventQueue_,t,i),i=[],d&&(e[a].status=2,function(u){setTimeout(u,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(h==="nodata"?s.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):s.push(()=>e[a].onComplete(new Error(h),!1,null))))}Vt(n,n.transactionQueueTree_);for(let a=0;a<s.length;a++)ot(s[a]);es(n,n.transactionQueueTree_)}function Vr(n,e){let t,s=n.transactionQueueTree_;for(t=C(e);t!==null&&Fe(s)===void 0;)s=Jn(s,t),e=x(e),t=C(e);return s}function qr(n,e){const t=[];return $r(n,e,t),t.sort((s,i)=>s.order-i.order),t}function $r(n,e,t){const s=Fe(e);if(s)for(let i=0;i<s.length;i++)t.push(s[i]);Ht(e,i=>{$r(n,i,t)})}function Vt(n,e){const t=Fe(e);if(t){let s=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[s]=t[i],s++);t.length=s,xr(e,t.length>0?t:void 0)}Ht(e,s=>{Vt(n,s)})}function tu(n,e){const t=ct(Vr(n,e)),s=Jn(n.transactionQueueTree_,e);return Oh(s,i=>{en(n,i)}),en(n,s),Ar(s,i=>{en(n,i)}),t}function en(n,e){const t=Fe(e);if(t){const s=[];let i=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(_(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(_(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),i=i.concat(Ie(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&s.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?xr(e,void 0):t.length=r+1,ve(n.eventQueue_,ct(e),i);for(let o=0;o<s.length;o++)ot(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cu="FIREBASE_DATABASE_EMULATOR_HOST",wn={};let hu=!1;function uu(n,e,t,s){n.repoInfo_=new zi(`${e}:${t}`,!1,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0),s&&(n.authTokenProvider_=s)}function du(n,e,t,s,i){let r=s||n.options.databaseURL;r===void 0&&(n.options.projectId||te("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),F("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=ri(r,i),a=o.repoInfo,l,c;typeof process<"u"&&Is&&(c=Is[cu]),c?(l=!0,r=`http://${c}?ns=${a.namespace}`,o=ri(r,i),a=o.repoInfo):l=!o.repoInfo.secure;const d=i&&l?new Ne(Ne.OWNER):new Rl(n.name,n.options,e);Uh("Invalid Firebase Database URL",o),E(o.path)||te("Database URL must point to the root of a Firebase Database (not including a child path).");const h=_u(a,n,d,new Sl(n.name,t));return new pu(h,n)}function fu(n,e){const t=wn[e];(!t||t[n.key]!==n)&&te(`Database ${e}(${n.repoInfo_}) has already been deleted.`),Jh(n),delete t[n.key]}function _u(n,e,t,s){let i=wn[e.name];i||(i={},wn[e.name]=i);let r=i[n.toURLString()];return r&&te("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new jh(n,hu,t,s),i[n.toURLString()]=r,r}class pu{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(zh(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new se(this._repo,b())),this._rootInternal}_delete(){return this._rootInternal!==null&&(fu(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&te("Cannot call "+e+" on a deleted database.")}}function mu(n=Za(),e){const t=Ka(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const s=Ho("database");s&&gu(t,...s)}return t}function gu(n,e,t,s={}){n=Mt(n),n._checkNotDeleted("useEmulator"),n._instanceStarted&&te("Cannot call useEmulator() after instance has already been initialized.");const i=n._repoInternal;let r;if(i.repoInfo_.nodeAdmin)s.mockUserToken&&te('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new Ne(Ne.OWNER);else if(s.mockUserToken){const o=typeof s.mockUserToken=="string"?s.mockUserToken:Vo(s.mockUserToken,n.app.options.projectId);r=new Ne(o)}uu(i,e,t,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yu(n){ul(Ja),yt(new Ye("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return du(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),Se(Ts,Ss,n),Se(Ts,Ss,"esm2017")}ee.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};ee.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};yu();const vu={apiKey:"AIzaSyAcdizRPIeFx-2YOreONXcsVVr6TCzAzXQ",authDomain:"tcom-659a5.firebaseapp.com",databaseURL:"https://tcom-659a5-default-rtdb.europe-west1.firebasedatabase.app",projectId:"tcom-659a5",storageBucket:"tcom-659a5.appspot.com",messagingSenderId:"228852455401",appId:"1:228852455401:web:3d1ca90f59c238aa4a9d78"},Cu=Ni(vu),Eu=mu(Cu),bn=no({items:[],async setItems(){const n=ou(Eu,"items");lu(n,async e=>{this.items=await e.val()})}}),wu={class:"hidden md:flex gap-2 flex-wrap px-2 py-2"},bu={class:"flex items-center"},Iu=g("div",{class:"w-16"},"Поиск:",-1),Tu={class:"flex items-center"},Su=g("div",{class:"w-16"},"Босс:",-1),Ru={key:0,class:"bg-gray-700 rounded w-full p-4 overflow-auto md:h-full mt-10 md:mt-0 h-full"},Nu={class:"flex justify-between"},xu={class:"text-green-500 text-lg gradient-text"},ku=g("svg",{width:"48",height:"48",viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",class:"transform scale-75"},[g("rect",{width:"48",height:"48",fill:"white","fill-opacity":"0.01"}),g("path",{d:"M12.3638 8L5.99981 14.364L12.3638 20.7279",class:"stroke-gray-800","stroke-width":"4","stroke-linecap":"round","stroke-linejoin":"round"}),g("path",{d:"M6 14.364L28.6722 14.364C35.557 14.364 41.2122 19.8028 41.4805 26.6824V26.6824C41.7641 33.952 35.9474 40 28.6722 40H12",class:"stroke-gray-800","stroke-width":"4","stroke-linecap":"round","stroke-linejoin":"round"})],-1),Au=[ku],Du={class:"md:px-4 md:max-h-[calc(100vh_-_200px)] max-h-[calc(100vh_-_120px)] overflow-y-auto scrollbar-thin scrollbar-custom"},Pu=["innerHTML"],Ou={key:0,class:"my-4"},Mu={class:"text-purple-500"},Lu={class:"md:px-2 flex flex-col gap-2"},Fu={key:0},Bu=g("span",{class:"uppercase text-red-600"},"Из чего скрафтить:",-1),Wu=["onClick"],Uu={class:"text-green-400 ml-2 text-right"},Hu={key:0},Vu={key:1},qu=g("span",{class:"uppercase text-red-600"},"Создается из",-1),$u={class:"text-purple-500 cursor-pointer w-full flex justify-between"},ju=["onClick"],zu={class:"text-green-400 ml-2 text-right"},Gu={key:2},Yu=g("span",{class:"uppercase text-red-600"},"Используется в:",-1),Ku={class:"w-full flex justify-between"},Qu=["onClick"],Xu={class:"text-green-400 ml-2 text-right"},Ju={key:3},Zu=g("span",{class:"uppercase text-red-600"},"Можно апнуть в кузнице в:",-1),ed={class:"w-full flex justify-between"},td=["onClick"],nd={class:"text-green-400 ml-2 text-right"},oi=Dt({__name:"ItemInfo",props:so({activeItem:{}},{name:{},nameModifiers:{},boss:{},bossModifiers:{}}),emits:["update:name","update:boss"],setup(n){const e=as(n,"name"),t=as(n,"boss"),s=ai(),i=q(()=>bn.items),r=q(()=>i.value.filter(l=>{var c;return(c=l.craft)==null?void 0:c.some(d=>d.items.find(h=>h.id===n.activeItem.id))})),o=q(()=>i.value.filter(l=>{var c;return(c=l.gems)==null?void 0:c.find(d=>d.id===n.activeItem.id)})),a=l=>{s.push({query:{item:l}})};return(l,c)=>{var d,h;return R(),A("div",null,[g("div",wu,[g("label",bu,[Iu,ls(g("input",{"onUpdate:modelValue":c[0]||(c[0]=u=>e.value=u),class:"bg-purple-200 border-2 rounded p-2 text-purple-950"},null,512),[[cs,e.value]])]),g("label",Tu,[Su,ls(g("input",{"onUpdate:modelValue":c[1]||(c[1]=u=>t.value=u),class:"bg-purple-200 border-2 rounded p-2 text-purple-950"},null,512),[[cs,t.value]])])]),l.activeItem?(R(),A("div",Ru,[g("div",Nu,[g("div",xu,z(l.activeItem.name),1),String(G(s).options.history.state.back).startsWith("/?item=")?(R(),A("button",{key:0,onClick:c[2]||(c[2]=(...u)=>G(s).back&&G(s).back(...u)),class:"text-red-300 text-4xl cursor-pointer"},Au)):J("",!0)]),g("div",Du,[g("article",{class:"mb-2",innerHTML:l.activeItem.description},null,8,Pu),l.activeItem.loot?(R(),A("div",Ou,[io(" Где достать: "),g("span",Mu,z(l.activeItem.loot),1)])):J("",!0),g("div",Lu,[(d=l.activeItem.craft)!=null&&d.length?(R(),A("div",Fu,[Bu,g("article",null,[(R(!0),A(Ee,null,we(l.activeItem.craft,(u,f)=>(R(),A("ul",{key:u.id,class:"w-full"},[(R(!0),A(Ee,null,we(u.items,(p,y)=>(R(),A("li",{key:p.id,class:"text-purple-500 cursor-pointer w-full flex justify-between"},[g("button",{onClick:w=>a(p.id),class:"text-left"},z(p.name),9,Wu),g("span",Uu,"("+z(p.loot)+")",1)]))),128)),f+1<l.activeItem.craft.length?(R(),A("span",Hu,"или")):J("",!0)]))),128))])])):J("",!0),(h=l.activeItem.gems)!=null&&h.length?(R(),A("div",Vu,[qu,g("article",null,[(R(!0),A(Ee,null,we(l.activeItem.gems,u=>(R(),A("ul",{key:u.id,class:"w-full"},[g("li",$u,[g("button",{onClick:f=>a(u.id),class:"text-left"},z(u.name),9,ju),g("span",zu,"("+z(u.loot||"?")+")",1)])]))),128))])])):J("",!0),r.value.length?(R(),A("div",Gu,[Yu,g("article",null,[(R(!0),A(Ee,null,we(r.value,u=>(R(),A("ul",{key:u.id,class:"w-full"},[g("li",Ku,[g("button",{onClick:f=>a(u.id),class:"cursor-pointer text-left text-purple-500"},z(u.name),9,Qu),g("span",Xu,"("+z(u.loot||"?")+")",1)])]))),128))])])):J("",!0),o.value.length?(R(),A("div",Ju,[Zu,g("article",null,[(R(!0),A(Ee,null,we(o.value,u=>(R(),A("ul",{key:u.id,class:"w-full"},[g("li",ed,[g("button",{onClick:f=>a(u.id),class:"cursor-pointer text-purple-500 text-left"},z(u.name),9,td),g("span",nd,"("+z(u.loot||"?")+")",1)])]))),128))])])):J("",!0)])])])):J("",!0)])}}}),sd=Dt({__name:"ItemButton",props:{title:{},active:{type:Boolean}},setup(n){return(e,t)=>(R(),A("button",{class:ro(["px-2 hover:text-green-950 hover:bg-white rounded text-base",e.active?"text-green-950 bg-white":"text-[rgba(235, 235, 235, 0.64)] bg-gray-700"])},z(e.title),3))}}),id=g("svg",{width:"24",height:"24",viewBox:"0 0 24 24"},[g("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),g("line",{x1:"6",y1:"6",x2:"18",y2:"18"})],-1),rd=[id],od=Dt({__name:"BaseModal",setup(n,{expose:e}){const t=W(),s=()=>{t.value&&t.value.showModal()},i=()=>{t.value&&t.value.close()};return e({open:s,close:i}),(r,o)=>(R(),A("dialog",{ref_key:"dialog",ref:t,class:"bg-gray-700 w-full h-full mx-auto"},[g("header",null,[g("button",{class:"fixed top-4 right-4 z-10",onClick:i},rd)]),oo(r.$slots,"default")],512))}});function ad(n){return lo()?(co(n),!0):!1}function ld(n){return typeof n=="function"?n():G(n)}const cd=typeof window<"u"&&typeof document<"u";typeof WorkerGlobalScope<"u"&&globalThis instanceof WorkerGlobalScope;function hd(n){return n||li()}function ud(n,e=!0,t){hd()?In(n,t):e?n():ao(n)}function Te(n){var e;const t=ld(n);return(e=t==null?void 0:t.$el)!=null?e:t}const Gr=cd?window:void 0;function dd(){const n=W(!1),e=li();return e&&In(()=>{n.value=!0},e),n}function fd(n){const e=dd();return q(()=>(e.value,!!n()))}function _d(n,e,t={}){const{window:s=Gr,...i}=t;let r;const o=fd(()=>s&&"ResizeObserver"in s),a=()=>{r&&(r.disconnect(),r=void 0)},l=q(()=>Array.isArray(n)?n.map(h=>Te(h)):[Te(n)]),c=Pt(l,h=>{if(a(),o.value&&s){r=new ResizeObserver(e);for(const u of h)u&&r.observe(u,i)}},{immediate:!0,flush:"post"}),d=()=>{a(),c()};return ad(d),{isSupported:o,stop:d}}function pd(n,e={width:0,height:0},t={}){const{window:s=Gr,box:i="content-box"}=t,r=q(()=>{var h,u;return(u=(h=Te(n))==null?void 0:h.namespaceURI)==null?void 0:u.includes("svg")}),o=W(e.width),a=W(e.height),{stop:l}=_d(n,([h])=>{const u=i==="border-box"?h.borderBoxSize:i==="content-box"?h.contentBoxSize:h.devicePixelContentBoxSize;if(s&&r.value){const f=Te(n);if(f){const p=s.getComputedStyle(f);o.value=Number.parseFloat(p.width),a.value=Number.parseFloat(p.height)}}else if(u){const f=Array.isArray(u)?u:[u];o.value=f.reduce((p,{inlineSize:y})=>p+y,0),a.value=f.reduce((p,{blockSize:y})=>p+y,0)}else o.value=h.contentRect.width,a.value=h.contentRect.height},t);ud(()=>{const h=Te(n);h&&(o.value="offsetWidth"in h?h.offsetWidth:e.width,a.value="offsetHeight"in h?h.offsetHeight:e.height)});const c=Pt(()=>Te(n),h=>{o.value=h?e.width:0,a.value=h?e.height:0});function d(){l(),c()}return{width:o,height:a,stop:d}}function md(n,e){const{containerStyle:t,wrapperProps:s,scrollTo:i,calculateRange:r,currentList:o,containerRef:a}="itemHeight"in e?vd(e,n):yd(e,n);return{list:o,scrollTo:i,containerProps:{ref:a,onScroll:()=>{r()},style:t},wrapperProps:s}}function Yr(n){const e=W(null),t=pd(e),s=W([]),i=ho(n);return{state:W({start:0,end:10}),source:i,currentList:s,size:t,containerRef:e}}function Kr(n,e,t){return s=>{if(typeof t=="number")return Math.ceil(s/t);const{start:i=0}=n.value;let r=0,o=0;for(let a=i;a<e.value.length;a++){const l=t(a);if(r+=l,o=a,r>s)break}return o-i}}function Qr(n,e){return t=>{if(typeof e=="number")return Math.floor(t/e)+1;let s=0,i=0;for(let r=0;r<n.value.length;r++){const o=e(r);if(s+=o,s>=t){i=r;break}}return i+1}}function Xr(n,e,t,s,{containerRef:i,state:r,currentList:o,source:a}){return()=>{const l=i.value;if(l){const c=t(n==="vertical"?l.scrollTop:l.scrollLeft),d=s(n==="vertical"?l.clientHeight:l.clientWidth),h=c-e,u=c+d+e;r.value={start:h<0?0:h,end:u>a.value.length?a.value.length:u},o.value=a.value.slice(r.value.start,r.value.end).map((f,p)=>({data:f,index:p+r.value.start}))}}}function Jr(n,e){return t=>typeof n=="number"?t*n:e.value.slice(0,t).reduce((i,r,o)=>i+n(o),0)}function Zr(n,e,t){Pt([n.width,n.height,e],()=>{t()})}function eo(n,e){return q(()=>typeof n=="number"?e.value.length*n:e.value.reduce((t,s,i)=>t+n(i),0))}const gd={horizontal:"scrollLeft",vertical:"scrollTop"};function to(n,e,t,s){return i=>{s.value&&(s.value[gd[n]]=t(i),e())}}function yd(n,e){const t=Yr(e),{state:s,source:i,currentList:r,size:o,containerRef:a}=t,l={overflowX:"auto"},{itemWidth:c,overscan:d=5}=n,h=Kr(s,i,c),u=Qr(i,c),f=Xr("horizontal",d,u,h,t),p=Jr(c,i),y=q(()=>p(s.value.start)),w=eo(c,i);Zr(o,e,f);const I=to("horizontal",f,p,a),S=q(()=>({style:{height:"100%",width:`${w.value-y.value}px`,marginLeft:`${y.value}px`,display:"flex"}}));return{scrollTo:I,calculateRange:f,wrapperProps:S,containerStyle:l,currentList:r,containerRef:a}}function vd(n,e){const t=Yr(e),{state:s,source:i,currentList:r,size:o,containerRef:a}=t,l={overflowY:"auto"},{itemHeight:c,overscan:d=5}=n,h=Kr(s,i,c),u=Qr(i,c),f=Xr("vertical",d,u,h,t),p=Jr(c,i),y=q(()=>p(s.value.start)),w=eo(c,i);Zr(o,e,f);const I=to("vertical",f,p,a),S=q(()=>({style:{width:"100%",height:`${w.value-y.value}px`,marginTop:`${y.value}px`}}));return{calculateRange:f,scrollTo:I,containerStyle:l,wrapperProps:S,currentList:r,containerRef:a}}const Cd={class:"md:w-1/2 w-full"},wd=Dt({__name:"HomeView",setup(n){const e=ai(),t=mo(),s=q(()=>bn.items),i=W(""),r=W(""),o=q(()=>{let w=s.value;return i.value&&(w=w.filter(I=>I.name.toLowerCase().includes(i.value.toLowerCase()))),r.value&&(w=w.filter(I=>{var S;return(S=I.loot)==null?void 0:S.toLowerCase().includes(r.value.toLocaleLowerCase())})),w.sort((I,S)=>{var j,Be,rs,os;return((j=I.craft)==null?void 0:j.length)<((Be=S.craft)==null?void 0:Be.length)?1:((rs=I.craft)==null?void 0:rs.length)>((os=S.craft)==null?void 0:os.length)?-1:0})}),{list:a,containerProps:l,wrapperProps:c,scrollTo:d}=md(o,{itemHeight:22}),h=W(null);In(async()=>{await bn.setItems(),t.query.item&&f(+t.query.item)});const u=W(),f=w=>{var I,S;e.push({query:{item:w}}),h.value=s.value.find(j=>j.id===w)||h.value,u.value&&((I=u.value)==null?void 0:I.clientWidth)<768&&((S=p.value)==null||S.open())};Pt(()=>t.query.item,async w=>{w&&(h.value=s.value.find(I=>I.id===+w)||h.value)}),W(!1);const p=W(null);W();const y=(w,I)=>{i.value=w,r.value=I,d(0)};return(w,I)=>(R(),A("main",{class:"w-full px-8 flex relative flex-wrap md:flex-col flex-col-reverse",ref_key:"main",ref:u},[hs(G(od),{ref_key:"modal",ref:p,class:"md:hidden md:pointer-events-none"},{default:uo(()=>[h.value?(R(),us(G(oi),{key:0,class:"w-full",activeItem:h.value,onSearch:y},null,8,["activeItem"])):J("",!0)]),_:1},512),g("div",Cd,[g("div",fo(G(l),{style:{height:"calc(100vh - 100px)"},class:"w-96 scrollbar-custom overflow-y-scroll"}),[g("div",_o(po(G(c))),[(R(!0),A(Ee,null,we(G(a),S=>{var j;return R(),A("div",{key:S.index,style:{height:"32px"},class:"mb-2 flex gap-2 w-fit"},[hs(G(sd),{title:S.data.name,onClick:Be=>f(S.data.id),active:S.data.id===((j=h.value)==null?void 0:j.id)},null,8,["title","onClick","active"])])}),128))],16)],16)]),h.value?(R(),us(G(oi),{key:0,activeItem:h.value,onSearch:y,name:i.value,"onUpdate:name":I[0]||(I[0]=S=>i.value=S),boss:r.value,"onUpdate:boss":I[1]||(I[1]=S=>r.value=S),class:"md:fixed md:block hidden w-1/2 max-w-3xl min-w-96 right-8 mx-2"},null,8,["activeItem","name","boss"])):J("",!0)],512))}});export{wd as default};
